...
Normalmente nao se faz isso a mao se for usar muito o pyqt5. Pois normalmente se utiliza o QT Designer
para criar janelas, todos os botoes la e apenas adicionar funcionalidades, botoes nas caixas de texto
ai nao precisa se preocupar com a interface em si

"""""


# QLineEdit = display da calculadora = input
# QSizePolicy Botoes auto se encaxam
...
class Calculadora(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.setFixedSize(400, 400)  # a Janela tem um tamanho definido
        self.cw = QWidget()
